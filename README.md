...
Para comprobar que el servidor está activo y que la conexión con la base de datos funciona, visita [http://localhost:3000/health](http://localhost:3000/health). Una respuesta con estado `200` confirma que el servicio está disponible y la base de datos conectada.
